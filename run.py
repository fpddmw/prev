...
if __name__ == '__main__':
    ...
    #tunor options
    parser.add_argument('--num_params', type=int, default=0, help='Number of parameters to use')
    parser.add_argument('--train_echos', type=int, default=0, help='Number of parameters to select in training phase')
    parser.add_argument('--tuning_echos', type=int, default=0, help='Number of parameters to select in testing phase')
    parser.add_argument('--pruner_mode', type=str, default='NoPruner', 
                        help='mode for pruner. options:["MedianPruner", "PercentilePruner", "NoPruner"]')
    parser.add_argument('--train_tuner', type=int, default=0, help='whether train new tuners')
    ...
    torch.cuda.manual_seed(fix_seed)  ##CHANGE##

    args.use_gpu = True if torch.cuda.is_available() and args.use_gpu else False
    print('if multi_gpu:', args.use_multi_gpu)
    if args.use_multi_gpu:
        torch.cuda.manual_seed_all(fix_seed)  ##CHANGE##
